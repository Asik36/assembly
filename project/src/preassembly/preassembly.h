 ...
 * @return int retval - SUCCESS if allocation was successful, FAIL otherwise
 */
 ...
 * @return int retval - SUCCESS if the line was added successfully, FAIL otherwise
 */
 ...
 * @return int retval - SUCCESS if the macros were listed successfully, FAIL otherwise
 */
 ...
 * @return int retval - SUCCESS if the macro was printed successfully, FAIL otherwise
 */
 ...
 * @return int retval - SUCCESS if the file was created successfully, FAIL otherwise
 */
